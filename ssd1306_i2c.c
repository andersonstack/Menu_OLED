...
// Definindo a tabela de fontes (um exemplo simples)
uint8_t font[] = {
    // Representação de caracteres (cada caractere é representado por 8 bytes)
    // Aqui estamos apenas representando alguns caracteres para o exemplo:
    // 'A' = 0x7F, 0x05, 0x05, 0x05, 0x7F
    0x7F, 0x05, 0x05, 0x05, 0x7F, // A
    0x7F, 0x15, 0x15, 0x15, 0x00, // B
